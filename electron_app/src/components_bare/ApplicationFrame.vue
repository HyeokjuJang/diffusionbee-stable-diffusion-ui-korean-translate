<template>
  <div class="main_frame">
    <div class="title_bar">
      <div
        class="app_title"
        v-bind:class="{ fullscreen: is_fullscreen || detect_windows_os() }"
      >
        <span @click="$emit('on_title_click', {})"> {{ title }} </span>
        <div
          style="float: right; margin-right: 10px; margin-top: -8.5px"
          class=""
        >
          <b-dropdown
            right
          ...
          >
            ...
            <b-dropdown-item-button
              @click="$emit('menu_item_click_model_license', {})"
              >Model License</b-dropdown-item-button
            >
            <b-dropdown-item-button
              @click="$emit('menu_item_click_oss_license', {})"
              >Open-source Licences</b-dropdown-item-button
            >

            <b-dropdown-item-button @click="$emit('menu_item_click_about', {})"
              >About</b-dropdown-item-button
            >
    ...
    <div class="tabs_bar">
      ...
      <div
        @click="selectTab('inpainting')"
        class="tab l_button"
        v-bind:class="{ button_colored: selected_tab === 'inpainting' }"
      >
        인페인팅
      </div>
      <div
        @click="selectTab('outpainting')"
        class="tab l_button"
    ...
    <div class="tab_content_frame">
      <div class="tab_content">
        <div
          style="display: none"
          :class="{ bl_display: selected_tab === 'txt2img' }"
        >
        ...
        <div
          style="display: none"
          :class="{ bl_display: selected_tab === 'img2img' }"
        >
          <slot name="img2img"></slot>
        </div>

        <div
          v-if="selected_tab === 'history'"
          style="display: none"
          :class="{ bl_display: selected_tab === 'history' }"
        >
        ...
        <div
          style="display: none"
          :class="{ bl_display: selected_tab === 'upscale_img' }"
        >
        ...
        <div
          style="display: none"
          :class="{ bl_display: selected_tab === 'inpainting' }"
        >
        ...
        <div
          style="display: none"
          :class="{ bl_display: selected_tab === 'outpainting' }"
        >
        ...
        <div
          style="display: none"
          :class="{ bl_display: selected_tab === 'settings' }"
        >
          <slot name="settings"></slot>
        </div>

        <div
          v-if="selected_tab === 'logs'"
          style="display: none"
          :class="{ bl_display: selected_tab === 'logs' }"
        >
          <slot name="logs"></slot>
        </div>
      </div>
