  ...
  <div style="float: right; margin-top: -5px">
    ...
    >
      <template #button-content>
        <div class="l_button" style="">고급설정</div>
      </template>
        ...
        >
          <span v-if="!elements_hidden.includes('inp_img_strength')">
            <div style="display: flex; flex-direction: column; width: 300px">
              ...
              <input
                ...
                min="10"
                max="90"
                :value="options_model_values.inp_img_strength * 100"
                step="0.01"
                class="slider"
                @input="SetStrength"
                list="tickmarks"
          ...
          <span v-if="!elements_hidden.includes('img_h')">
            <div class="options_title">
              ...
              <div style="display: inline-flex; gap: 22px">
                <div
                  class="options_input"
                  style="justify-content: center; width: 75px"
                >
                  <svg
                    width="18"
                    height="20"
                  ...
                  >
                    <path
                      ...
                      stroke="#A2A3AA"
                      stroke-width="1.01368"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M5.78269 9.1374H2.23482"
                      stroke="#A2A3AA"
                      stroke-width="1.01368"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    ...
                    />
                    <path
                      d="M3.75533 7.61689L2.23482 9.1374L3.75533 10.6579"
                      stroke="#A2A3AA"
                      stroke-width="1.01368"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M9.83737 7.61689L11.3579 9.1374L9.83737 10.6579"
                      stroke="#A2A3AA"
                      stroke-width="1.01368"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M8.57599 9.1374L10.0965 10.6579L11.617 9.1374"
                      stroke="#A2A3AA"
                      stroke-width="1.01368"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M8.57599 3.05534L10.0965 1.53483L11.617 3.05534"
                      stroke="#A2A3AA"
                      stroke-width="1.01368"
                      stroke-linecap="round"
                      stroke-linejoin="round"
            ...
            <span v-if="!elements_hidden.includes('batch_size')">
              <div class="options_title">
                ...
                <div class="options_input" style="width: 75px">
                  ...
                  >
                    <path
                      d="M1 13.5H5V9.5H9V5.5H13V1.5H17"
                      stroke="#A2A3AA"
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
          ...
          <div class="options_title">
            ...
            <div class="options_input" style="width: 125px">
              ...
              <b-form-input
                ...
                class="custom-input"
                v-model="options_model_values.seed"
                type="number"
                width="70"
                value="100"
                maxlength="5"
          ...
          <div class="options_title">
            ...
            <div class="options_input" style="width: 115px">
              ...
              <b-form-select
                v-model="options_model_values.selected_model"
                :options="
                  ['Default'].concat(
                    Object.keys(
                      options_model_values.app_state.app_data.custom_models
                    )
                  )
                "
                required
            ...
            <div class="options_input" style="width: 75px">
              <div
                v-if="
                  ...
                  !elements_hidden.includes('nagative_prompt')
                "
                class="l_button"
                @click="
                  options_model_values.is_negative_prompt_avail =
    ...
    this.$nextTick(function () {
      ...
      for (var i = 0; i < sliders.length; i++) {
        ...
        slider.style.background =
          "linear-gradient(to right, var(--slider-progress) 0%, var(--slider-progress) " +
          value +
          "%, var(--slider-progress_end) " +
          value +
          "%, var(--slider-progress_end) 100%)";
      }
    });
  },
  data() {
...
.slider {
  background: linear-gradient(
    ...
    var(--slider-progress) 37.5%,
    var(--slider-progress_end) 37.5%,
    var(--slider-progress_end) 100%
  );
  border-radius: 8px;
  height: 15px;
